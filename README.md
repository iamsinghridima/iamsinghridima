...
Biology Major | Data Science Minor | 4th Year BSMS 

## About
Being a biology major and data science minor, my interests lie in interdisciplinary research that integrates theoretical, experimental, and computational approaches. My academic interests span across biophysics, biochemistry, protein modeling, systems biology, cellular & moleculer biology, biotechnology, bioinformatics, genomics and neuroscience. I am currently working on proteostasis, modeling simulations and developmental biology networks. I have gained hands-on experience working with genetic tools, performing moleculer biology techniques, studying theoretical modeling of membrane dynamics, and applying exploratory data analysis, which has strengthened my ability to approach biological problems from multiple perspectives.

## Tech Stack
[![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)
[![MATLAB](https://img.shields.io/badge/MATLAB-3776AB?style=for-the-badge&logo=matlab&logoColor=white)](https://www.mathworks.com/products/matlab.html)
...
## Projects
- [![Reprogramming of Cardiomyocyte](https://img.shields.io/badge/Single%20Cell%20RNA%20seq%20Neuronal%20Cell%20Type%20Classification-6A1B9A?style=flat-square)](https://github.com/iamsinghridima/RNA-seq-Neuron-Classification.git) ![May 2026](https://img.shields.io/badge/May%202026-555?style=flat-square)<br>
  Networks in Development to Elucidate the Tree of Key Transcription Factors Governing Cellular Specialisation for Reprogramming the Cardiomyocyte. Constructed a literature-derived regulatory network to investigate key transcription factors and signaling interactions governing cellular specialization toward a cardiomyocyte state. Designed and visualized network topology. Developed a Boolean network model and performed network simulations.
